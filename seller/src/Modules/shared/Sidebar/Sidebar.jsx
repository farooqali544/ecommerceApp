...
const items = [
  ...
  { id: 2, name: "Products", icon: <CategoryIcon />, path: "/products" },
  { id: 3, name: "Orders", icon: <DashboardIcon />, path: "/orders" },
...
function Sidebar({ collapsed, setCollapsed, activeComponent }) {
  ...
  if (activeComponent.includes("/product/")) activeComponent = "/products";
